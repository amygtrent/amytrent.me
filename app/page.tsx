...
{hovered && hoveredImage && (
  <img
    ...
    style={{
      position: "fixed",
      pointerEvents: "none",
      width: "128px",          // keep width or adjust as needed
